 ...
 * @author rubensworks
 */
public class VanillaEntityItemFrameChemicalHandler extends VanillaEntityItemFrameCapabilityDelegator<IChemicalHandler> implements IChemicalHandler {

    public VanillaEntityItemFrameChemicalHandler(ItemFrame entity) {
        super(entity);
    }
