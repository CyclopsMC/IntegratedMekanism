 ...
 * @author rubensworks
 */
public class ValueTypeRecipeChemicalLPElementPropertiesSubGui extends ValueTypeRecipeAdapterLPElementPropertiesSubGui<ValueTypeRecipeChemicalLPElement> {
    public ValueTypeRecipeChemicalLPElementPropertiesSubGui(ValueTypeRecipeChemicalLPElement element, int baseX, int baseY, int maxWidth, int maxHeight, ContainerScreenLogicProgrammerBase gui, ContainerLogicProgrammerBase container, int slotId) {
    ...
    public ItemStack getSlotContents() {
        return container.slots.get(slotId + ValueTypeRecipeChemicalLPElement.SLOT_OFFSET).getItem();
    }
